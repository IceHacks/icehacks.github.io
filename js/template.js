...
Vue.component("ice-sidebar", {
	template: `
		<ice-section size="0.8" width="450">
			...
			<ice-social color="#36393f" title="Discord" button="JOIN" button-color="#738bd7" url="https://discord.gg/mvsqsfG"></ice-social>
		</ice-section>
	`
});
		...
		<div>
			<ul class="navbar">
				<div class="inner">
					...
					<li class="navbar-li"><a v-bind:class="(typeof client == 'string' ? 'navbar-active' : '') + ' navbar-list'" href="/icedout/">Client Area</a></li>
				</div>
			</ul>
		</div>
	`
