...
Vue.component("ice-sidebar", {
	template: `
		<ice-section size="0.8" width="450">
			...
			<ice-social color="#36393f" title="Discord" button="JOIN" button-color="#738bd7" url="https://discord.gg/RHjRGfr"></ice-social>
		</ice-section>
	`
});
	...
	template: `
		<div>
			...
			<ice-box v-for="(b, id) in data" :title=b.title>
				<div v-html="linkToHTML(markdown(b.content))"></div>
